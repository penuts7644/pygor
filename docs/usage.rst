...
.. code-block:: ini
    ...
    ; Name of the column containing the V family name string.
    V_FAMILY_COL = v_family
    ; Name of the column containing the V gene name string.
    V_GENE_COL = v_gene
    ; Name of the column containing the J family name string.
    J_FAMILY_COL = j_family
    ; Name of the column containing the J gene name string.
    J_GENE_COL = j_gene

    ; Parameters specific for the 'generate' tool.
    [GENERATE]
    ; Name of the column containing the D gene choice string.
    D_GENE_CHOICE_COL = gene_choice_d

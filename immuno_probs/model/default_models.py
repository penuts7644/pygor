...
def get_default_model_file_paths(model_name):
    ...
    default_models = {
        'human-t-alpha': {
            ...
            'reference': {
                'V': resource_filename(pkg_name, os.path.join('default_models', 'human_t_alpha', 'genomic_V.fasta')),
                'J': resource_filename(pkg_name, os.path.join('default_models', 'human_t_alpha', 'genomic_J.fasta')),
            },
        },
        'human-t-beta': {
            ...
            'reference': {
                'V': resource_filename(pkg_name, os.path.join('default_models', 'human_t_beta', 'genomic_V.fasta')),
                'D': resource_filename(pkg_name, os.path.join('default_models', 'human_t_beta', 'genomic_D.fasta')),
                'J': resource_filename(pkg_name, os.path.join('default_models', 'human_t_beta', 'genomic_J.fasta')),
            },
        },
        'human-b-heavy': {
            ...
            'reference': {
                'V': resource_filename(pkg_name, os.path.join('default_models', 'human_b_heavy', 'genomic_V.fasta')),
                'D': resource_filename(pkg_name, os.path.join('default_models', 'human_b_heavy', 'genomic_D.fasta')),
                'J': resource_filename(pkg_name, os.path.join('default_models', 'human_b_heavy', 'genomic_J.fasta')),
            },
        },
        'mouse-t-beta': {
            ...
            'reference': {
                'V': resource_filename(pkg_name, os.path.join('default_models', 'mouse_t_beta', 'genomic_V.fasta')),
                'D': resource_filename(pkg_name, os.path.join('default_models', 'mouse_t_beta', 'genomic_D.fasta')),
                'J': resource_filename(pkg_name, os.path.join('default_models', 'mouse_t_beta', 'genomic_J.fasta')),
            },
        },
    }
